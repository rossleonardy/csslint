...
###Pitfalls
1. CSSLint-WPTheme should work with Wordpress 4.7 and up, but it doesn't check for a version, and the list of selectors it checks for may either include or exclude selectors necessary for what your theme is targeting.
